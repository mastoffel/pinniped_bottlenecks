...
test_df <- mutate(tree_df, 
    color = case_when(is.na(BreedingType) ~ "#bdbdbd",
        BreedingType == "ice"~ "#bdbdbd",
        BreedingType == "land" ~ "#bdbdbd"))
...
p <- p +  #layout="circular" , "fan"open.angle=180  #,color = "#737373"
    ...
    geom_tippoint(stroke=0.5, color = "#737373", size = 3, alpha = 0.8) + #shape=21,stroke=0.5 #color = "#737373" color = "#737373"
...
save_plot("figures/DZG_talk/phylo_plot.jpg", p_final,
