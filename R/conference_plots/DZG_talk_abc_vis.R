...
abc$species <- factor(abc$species, levels = c("california_sea_lion", "antarctic_fur_seal",  "south_american_fur_seal", "galapagos_fur_seal",
    "grey_seal_orkneys", "saimaa_ringed_seal",     "lagoda_ringed_seal", "mediterranean_monk_seal", "hawaiian_monk_seal", "nes"))
...
p <- abc %>% filter(pars == "nbot") %>% 
    ...
    geom_quasirandom(alpha = 0.02, size = 2, color = "#053061", width = 0.45, bandwidth = 1.5) +
...
p
ggsave(filename = "figures/DZG_talk/abc_posteriors2.jpg", plot = p, width = 6.7, height = 9.5)
