...
# save(all_seals, file = "data/processed/all_seals.Rdata")
# save(all_seals_hw, file = "data/processed/all_seals_hw.Rdata")

# load("data/processed/all_seals.Rdata")
# load("data/processed/all_seals_hw.Rdata")
